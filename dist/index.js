...
const composeReport = (commitMessagesList) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const result = ((_a = response.data.choices[0].message) === null || _a === void 0 ? void 0 : _a.content) || '';
    return result;
});
exports.composeReport = composeReport;
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.fetchCommitMessages = void 0;
const child_process_1 = __nccwpck_require__(2081);
const util_1 = __nccwpck_require__(3837);
const execAsync = (0, util_1.promisify)(child_process_1.exec);
const fetchCommitMessages = (daysCount) => __awaiter(void 0, void 0, void 0, function* () {
    const { stdout } = yield execAsync(`git log --since="${daysCount} days ago" --pretty=format:"%s"`);
...
const fetch_commit_messages_1 = __nccwpck_require__(5825);
const compose_report_1 = __nccwpck_require__(696);
/**
